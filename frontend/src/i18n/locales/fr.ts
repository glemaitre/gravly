export default {
  ...
  // Wahoo integration
  wahoo: {
    loginSuccess: 'Connexion à Wahoo réussie',
    loginError: 'Échec de la connexion à Wahoo',
    completingLogin: 'Finalisation de la connexion...',
    redirecting: 'Redirection...'
  },
  ...
  editor: {
    ...
    enableAutoZoom: 'Activer le zoom/pan automatique',
    disableAutoZoom: 'Désactiver le zoom/pan automatique'
  },
