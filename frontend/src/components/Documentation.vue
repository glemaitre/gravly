<template>
  <div class="documentation-page">
      ...
      <div class="header-wrapper">
        <nav class="documentation-nav">
          ...
          >
            ...
            <span>{{ $t('documentation.connections') }}</span>
          </a>
          <a
            href="#explorer"
          ...
          >
            ...
            <span>{{ $t('documentation.explorer') }}</span>
          </a>
          <a
            href="#planner"
          ...
          >
            ...
            <span>{{ $t('documentation.planner') }}</span>
          </a>
          <a
          ...
          >
            ...
            <span>{{ $t('documentation.editor') }}</span>
          </a>
        </nav>
      </div>
    </div>
    ...
    <div class="documentation-content">
      <!-- Connections Section -->
      <section id="connections" ref="connectionsSection" class="documentation-section">
        ...
        <div class="section-content">
          <p>
            Gravly integrates with Strava and Wahoo to enhance your experience. Connect
            these services to unlock additional features and capabilities.
          </p>

          <h3>Connecting Services</h3>
          <p>
            To connect or manage services, click the <strong>Menu</strong> button (three
            dots) in the top-right corner of the navbar. You'll find the "Connected
            Services" section at the top of the menu.
          </p>
          ...
          <ol>
            ...
            <li>
              After authorizing, you'll be redirected back to Gravly and your connection
              will be active
            </li>
          </ol>
          ...
          <p>
            ...
            ></i
            >) next to the Strava service in the menu. Note that disconnecting may limit
            access to features that require authentication.
          </p>
          ...
          <ul>
            <li>
              <strong>Route Upload:</strong> Upload routes directly to Wahoo Cloud from
              the segment detail page
            </li>
            <li>
              <strong>Automatic Format Conversion:</strong> GPX files are automatically
              converted to FIT format for Wahoo device compatibility
            </li>
            <li>
            ...
            <li>
              <strong>Route Management:</strong> Update or delete routes that have been
          ...
          <p>
            Once connected to Wahoo, you can upload routes from the segment detail page:
          </p>
          <ul>
            ...
            <li>
              The route will be automatically converted to FIT format and synced to your
              devices
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              Connections are secure and use OAuth 2.0 authentication - your credentials
              are never stored directly in Gravly
            </li>
          </ul>
        </div>
      </section>
      ...
      <section id="explorer" ref="explorerSection" class="documentation-section">
        ...
        <div class="section-content">
          <p>
            The Explorer allows you to browse and discover gravel segments and routes in
            your area. Use the interactive map to explore terrain and find the perfect
            segments for your next ride.
          </p>
          ...
          <ul>
            <li><strong>Track Type:</strong> Switch between "Segments" and "Routes"</li>
            <li><strong>Difficulty Level:</strong> Filter by difficulty (1-5)</li>
            <li>
              <strong>Surface Type:</strong> Select specific surface types (paved roads,
              stone roads, trails, etc.)
            </li>
            <li>
              <strong>Tire Recommendations:</strong> Filter by tire type needed (slick,
              semi-slick, knobs) for dry or wet conditions
            </li>
            <li>
          ...
          <p>
            <strong>Hovering</strong> over a segment card highlights it on the map with
            a colored rectangle. <strong>Clicking</strong> on a segment card selects it
            and shows it highlighted on the map. Click again to navigate to the segment
          ...
          <ul>
            ...
            <li>
              <strong>Map Navigation:</strong> Pan by dragging, zoom with mouse wheel or
          ...
          <ul>
            ...
            <li>
              Use filters to narrow down segments that match your riding preferences and
              conditions
            </li>
            <li>
      ...
      <section id="planner" ref="plannerSection" class="documentation-section">
        ...
        <div class="section-content">
          ...
          <h3>Routing Modes</h3>
          <p>
            Click the <strong>Route</strong> button (🗺️) in the top-right corner to open
            the sidebar and choose between two routing modes:
          </p>

          <h4>Free Mode</h4>
          <p>
            Create routes by adding multiple waypoints freely. The system automatically
            generates routes between waypoints, allowing you to create complex routes
          ...
          <ul>
            ...
            <li>
              <strong>Undo (↶):</strong> Undo the last action (waypoint added, moved, or
              removed)
            </li>
          ...
          <h3>Tips</h3>
          <ul>
            <li>Use Free Mode for exploring and creating routes with multiple stops</li>
            <li>
      ...
      >
        ...
        <div class="section-content">
          ...
          <p>Load an existing segment from the Gravly database to edit or update it:</p>
          <ul>
          ...
          <ul>
            ...
            <li>
              Drag the <strong>end marker</strong> (red) to set where your segment ends
            </li>
            <li>
          ...
          <p>
            You can also use the navigation buttons to move markers one point at a time
          ...
          <ul>
            <li>
              <strong>Difficulty Level:</strong> Rate the difficulty from 1 (very easy)
              to 5 (very hard)
            </li>
            <li>
          ...
          <ul>
            <li><strong>Save as New:</strong> Create a new segment in the database</li>
            <li>
              <strong>Update in DB:</strong> Update an existing segment (only available
              when editing a segment from the database)
            </li>
            <li>
          ...
          <!-- Screenshot -->
          <img
            :src="editorSavingImage"
            alt="Save Actions"
            class="documentation-image documentation-image-editor-saving"
          />
          ...
          <ul>
            ...
            <li>
              Add detailed descriptions and media to make your segments more valuable to
              the community
            </li>
            <li>
            ...
            <li>
              Review your segment on the map before saving to ensure the boundaries are
              correct
            </li>
          </ul>
        </div>
...
import editorImportGpxVideo from '../assets/doc/editor_import_gpx.mp4'
import editorImportStravaVideo from '../assets/doc/editor_import_strava.mp4'
import editorImportDatabaseVideo from '../assets/doc/editor_import_database.mp4'
import editorSelectorVideo from '../assets/doc/editor_selector.mp4'
import editorMetadataVideo from '../assets/doc/editor_metadata.mp4'
import editorSavingImage from '../assets/doc/editor_saving.png'
...
.documentation-section {
  scroll-margin-top: calc(var(--navbar-height, 60px) + 70px);
}
...
.documentation-image-editor-saving {
  width: 150px;
  max-width: 100%;
}
